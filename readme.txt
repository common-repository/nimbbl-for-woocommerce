...
Welcome to the official Nimbbl WooCommerce plugin. Get higher conversions with multiple payment gateways, UPI, BNPL and more in a single integration.
...
Nimbbl WooCommerce is an open source software. The following people have contributed to this plugin.
...
= 4.0.4 =
* Plugin Version Correction & Bug Fixes

= 4.0.3 =
* Webhook & Callback Signature V3 Support
...
Here's a link to [Nimbbl WooCommerce ](https://wordpress.org/woo-nimbbl "Nimbbl WooCommerce")
